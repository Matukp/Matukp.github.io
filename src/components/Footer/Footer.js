    ...
    return (
        <footer className="footer">
            ...
            <div className="footer__contact">
                <h3 className="footer-title">Diseñado por Matukp</h3>
                <ul className='contact__icons'>
                    <li><a href='' target='_blank' rel='noreferrer'><FacebookOutlinedIcon/></a></li>
                    <li><a href='Matiasuriel18@hotmail.com' target='_blank' rel='noreferrer'><EmailIcon/></a></li>
                    <li><a href='https://github.com/Matukp' target='_blank' rel='noreferrer'><GitHubIcon/></a></li>
                    <li><a href='https://www.linkedin.com/in/matias-rodriguez-7a6b29172/' target='_blank' rel='noreferrer'><LinkedInIcon/></a></li>
                </ul>
            </div>
